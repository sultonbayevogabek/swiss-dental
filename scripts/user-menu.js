...
elUserMenu.addEventListener("click", (evt) => {
   ...
   if (!elModalUser.classList.contains("fade-in")) {
      ...
      window.addEventListener("click", (evt) => {
         if (!evt.target.classList.contains("modal__content") && !(evt.target.classList.contains("user__menu") || evt.target.classList.contains("user__menu__img") || evt.target.classList.contains("user__menu__text") || evt.target.classList.contains("icon__bottom") || evt.target.classList.contains("user__img__wrapper"))) {
   ...
   if (elModalUser.classList.contains("fade-out")) {
      clearClasses();
   }
})